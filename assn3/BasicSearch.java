...
public class BasicSearch {
  ...
  public static void main(String[] args){
    ...
    // Term query
	private void TermQuery(String theSearch)throws IOException, ParseException 
	{
    	try 
		{
     		IndexReader reader = DirectoryReader.open(FSDirectory.open(Paths.get(indexDirName)));
      		...
      		Term term = new Term(field, theSearch);
    ...
    // Boolean query
	private void BooleanQuery(String theSearch1, String theSearch2)throws IOException, ParseException 
	{
    	try 
		{
      		IndexReader reader = DirectoryReader.open(FSDirectory.open(Paths.get(indexDirName)));
