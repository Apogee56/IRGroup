...
#testing.    still need testing im not done!!!
#gets full phrase
phraseQ = input("Please enter a phrase / proximity query: ")
#splits phrase into 3 variables
#exp: docu /50 text ;  a = docu, b = /50, c = text
a,b,c = phraseQ.split()
result = proxIntersect(a,c,b.isdigit())
